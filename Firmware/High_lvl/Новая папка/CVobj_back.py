...
while True:
    ...
    data_to_send = struct.pack('<hhh', round(cur_ang*-1000), 1, 1)
    print(f"Rec: {receive} Gyr: {gyro}, ball: {ball.main_vec.ang}, sum: {cur_ang}, send: {data_to_send}")
